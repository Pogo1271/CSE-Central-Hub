        ...
        <div className="flex flex-col justify-center space-y-6">
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Your comprehensive platform for managing businesses, teams, and analytics.
            </p>
          </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 border rounded-lg bg-blue-50">
                  <h3 className="font-semibold text-gray-900 mb-2">Demo Accounts Available</h3>
                  <div className="space-y-2 text-sm">
                    <div><strong>Admin:</strong> admin@businesshub.com / admin123</div>
                    <div><strong>Manager:</strong> manager@businesshub.com / manager123</div>
                    <div><strong>User:</strong> user@businesshub.com / user123</div>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <div className="text-center lg:text-left text-sm text-gray-500">
            <p>
              New users will be created with basic permissions. Administrators can upgrade user roles as needed.
            </p>
          </div>
        </div>
